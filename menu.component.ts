...
@Component({
  selector: 'app-menu',
  standalone: true,
  imports: [NgFor,NgForOf,CommonModule,RouterLink,RouterLinkActive,RouterOutlet,NgIf],
  ...
  menuItems = [
    {
      ...
      price2:'Price', 
      amt2 :'-5',
      image2:'https://cianblog.com/wp-content/uploads/2019/08/1248-2-B1905.jpg',
      ingredients: [
      ...
      ],   },
    {
      ...
      price2:'Price', 
      amt2 :'-5',
      image2:'https://images.squarespace-cdn.com/content/v1/5f4e7155ce513218e4076c12/1624485851137-SLEWNB3B7QG0ZC8WBR1Z/_T1A4908.jpeg?format=1000w',
      ingredients: [
    ...
    },
    {
      ...
      price2:'Price', 
      amt2 :'-5',
      image2:'https://image.freepik.com/free-photo/clouse-up-fresh-ice-coffee-cold-americano-coffee-shop-background_1553-212.jpg',
      ingredients: [
      ...
      ],    },
    {
      ...
      name2: 'Blue Ice Cocktail',
      price2:'Price', 
      amt2 :'-5',
      image2:'https://th.bing.com/th/id/R.66723e80c568d9f4bcbb2a86858f4831?rik=MZDjr6j%2b5PyVjA&riu=http%3a%2f%2fyannys.in%2fimages%2fblue-iced.webp&ehk=wxO1EWpYLR2K17C%2fh3CKJHbL7B3LNkdDOMsIuov6XuM%3d&risl=&pid=ImgRaw&r=0',
      ingredients: [
      ...
      ],    },
    {
      ...
      price2:'Price', 
      amt2 :'-5',
      image2:'https://img.freepik.com/premium-photo/latte-art-cappuccino_1031776-27287.jpg',
      ingredients: [
        { name: 'Chicken', quantity: '200g' },
        { name: 'Lemon Juice', quantity: '2 tbsp' },
        { name: 'Garlic', quantity: '2 cloves' },
